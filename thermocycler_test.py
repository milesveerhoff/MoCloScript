...
def run(protocol: protocol_api.ProtocolContext):
    ...
    tc_mod.set_block_temperature(temperature=37, hold_time_seconds=900, block_max_volume=rxn_vol) # 15 min
    for i in range(25):
        tc_mod.set_block_temperature(temperature=37, hold_time_seconds=90, block_max_volume=rxn_vol) # 1.5 min
        tc_mod.set_block_temperature(temperature=16, hold_time_seconds=180, block_max_volume=rxn_vol) # 3 min
    tc_mod.set_block_temperature(temperature=50, hold_time_seconds=600, block_max_volume=rxn_vol) # 10 min
    tc_mod.set_block_temperature(temperature=65, hold_time_seconds=600, block_max_volume=rxn_vol) # 10 min
